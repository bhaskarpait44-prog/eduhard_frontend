...
const ReceiptDetail = () => {
  ...
  const modeVariant = paymentModeBadge(receipt?.payment_mode)
      ...
      >
        <div className="flex items-center gap-3">
          <button
            type="button"
            onClick={() => navigate(-1)}
            className="w-9 h-9 rounded-full flex items-center justify-center border transition-colors hover:opacity-70"
        ...
        {receipt && (
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              onClick={handlePrint}
              className="flex items-center gap-2 rounded-lg px-4 py-1.5 text-sm font-medium border transition-colors hover:opacity-80"
            ...
            >
              ...
              <div>
                ...
                <div className="flex items-center justify-between py-2.5">
                  ...
                  <Badge variant={modeVariant}>{receipt.payment_mode}</Badge>
                </div>
              </div>
            </div>
